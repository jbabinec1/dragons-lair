...
QUICK START
------------------------------------------
To get started with using PolyNav:
1. Create your first navigation map through "Tools/ParadoxNotion/PolyNav/Create PolyNav Map".
    - A gameobject with the PolyNav2D component and a PolygonCollider2D will be created.
2. Modify the PolygonCollider2D to shape out the navigation area using the default Unity controls.
...
8. Remember to open up the DEMO scene included to see all the above in action!
